...
$idpName = '/preprod';
$spBaseUrl = 'https://uniconv-pp.unicam.it/public/saml2' . $idpName;
...
return $settings = array(
    ...
    'baseurl' => $spBaseUrl,
    'sp' => array(
        'entityId' => 'https://uniconv-pp.unicam.it/public/api/loginSaml',
        ...
        "attributeConsumingService" => array(
            "serviceName" => "Uniconv-pp",
            //like in *AttributeFilter*
            "serviceDescription" => "Uniconv-pp",
    ...
    'idp' => array(
        ...
        'singleLogoutService' => array(
            ...
            'responseUrl' => 'https://uniconv-pp.unicam.it:8443/sp/index.php?sls',
            'binding' => 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect',
        ),
        //'x509cert' => '',
        'x509certMulti' => array(
